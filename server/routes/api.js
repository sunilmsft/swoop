...
router.patch('/leads/:id', (req, res) => {
  const { lead_status, notes, caller_name, location_hint, ai_handoff_done, ai_turn_count, urgency_level } = req.body;
  ...
  if (location_hint !== undefined) { updates.push('location_hint = ?'); values.push(location_hint); }
